...
public class DebugCmd extends OwnerCommand {
  ...
  protected void execute(CommandEvent event) {
    ...
    sb
      ...
      .append("\n  Version = ")
      .append(OtherUtil.getCurrentVersion())
      .append("\n  Owner = ")
    ...
    if (
      ...
      .getChannel()
      .sendFile(sb.toString().getBytes(), "debug_information.txt")
      .queue(); else event.reply("Debug Information: " + sb.toString());
  }
}
