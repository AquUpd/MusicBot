    ...
    public void doCommand(CommandEvent event) throws IOException {
        ...
        if(argument.length() != 0) {
            ...
            switch (argument.toLowerCase(Locale.ENGLISH)) {
                ...
                case "бумага": rpsplayer = 2; rpsplayername = "бумага"; break;
                default: event.replyError("Напишите \"камень\", \"ножницы\" или \"бумага\" после команды."); return;
            }

            if(rpsbot == rpsplayer){
                result = "Ничья!"; emoji = ":upside_down: ";
            } else if((rpsplayer == 0 && rpsbot == 1) || (rpsplayer == 1 && rpsbot == 2) || (rpsplayer == 2 && rpsbot == 0)){
                result = "Вы победили!"; emoji = ":sunglasses: ";
            } else {
                result = "Вы проиграли!"; emoji = ":sob: ";
            }
